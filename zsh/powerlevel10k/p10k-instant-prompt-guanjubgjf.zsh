.python-version|.go-version|.ruby-version|.lua-version|.java-version|.perl-version|.php-version|.tool-version|.shorten_folder_marker|.svn|.terraform|CVS|Cargo.toml|composer.json|go.mod|package.json|stack.yaml)\C-Atruncate_to_unique\C-Afalse\C-A1\C-A3\C-Atrue\C-A1\C-A3\C-A✘\C-Atrue\C-A1\C-A3\C-A✘\C-A✘\C-Atrue\C-Afalse\C-A0\C-A2\C-Atrue\C-A0\C-A2\C-A✔\C-A✔\C-Afalse\C-A3\C-A0\C-A6\C-A0\C-A*\C-BOTHER\C-A0\C-A4\C-Afalse\C-A0\C-A4\C-Aterraform|tf\C-A7\C-A0\C-A%D{%H:%M}\C-Afalse\C-A8\C-A${P9K_CONTENT:0:24}${${P9K_CONTENT:24}:+…}\C-A255\C-A8\C-A0\C-Afalse\C-Atrue\C-Aoff\C-Agit\C-A\\uF126 \C-A2\C-A-1\C-A-1\C-A3\C-A-1\C-A${$((my_git_formatter()))+${my_git_format}}\C-A~\C-Atrue\C-A8\C-A-1\C-A3\C-A-1\C-A-1\C-A2\C-A?\C-A-1\C-ANORMAL\C-A\C-A0\C-A8\C-A2\C-A3\C-A4\C-A2\C-A0\C-AOVERTYPE\C-A4\C-A0\C-A\C-A\C-Afalse\C-Afalse\C-AVISUAL\C-A6\C-A\C-A0\C-A(gpd|wg|(.*tun)|tailscale)[0-9]*\C-Afalse\C-A4\C-A0\C-A6\C-A0'
  local gitstatus_dir=/home/guanjubgjf/.oh-my-zsh/custom/themes/powerlevel10k/gitstatus
  ...
  local cr=$'\r' lf=$'\n' esc=$'\e[' rs=$'\x1e' us=$'\x1f'
  local -i height=1
  local prompt_dir=/home/guanjubgjf/.cache/p10k-guanjubgjf
  ...
  if [[ $langinfo[CODESET] != (utf|UTF)(-|)8 ]]; then
    ...
    [[ -z $loc_cmd ]] && loc_cmd=/usr/sbin/locale
    if [[ -x $loc_cmd ]]; then
      local -a locs
  ...
  local -A _p9k_display_k=(-2/left 11 2/left 59 -2/right/nodenv 33 1/right/background_jobs 27 1/right/nvm 35 -2/right/node_version 39 -1/right 61 1/right/vim_shell 49 -2/right/nvm 35 1/right/rust_version 41 1/left/dir 19 -2/right/ranger 47 1/right/nodenv 33 -1/left 59 -2/right/context 45 -2/left/vcs 21 1/right/virtualenv 29 1/right/node_version 39 1/right_frame 9 1/right 13 2/right 61 -2/right/virtualenv 29 1/right/pyenv 31 1/right/nodeenv 37 -2/right 13 -2/right/background_jobs 27 2/right_frame 57 -2/right_frame 9 1/right/ranger 47 -2/right/pyenv 31 empty_line 1 -1/left/prompt_char 65 2/left/prompt_char 65 -1 53 1/right/context 45 -2/right/package 43 -2 5 1/left 11 -1/gap 63 -1/right_frame 57 -2/right/vim_shell 49 -2/gap 15 1/left/vcs 21 1/right/time 51 -2/right/status 23 1 5 1/left_frame 7 -1/left_frame 55 2 53 -2/right/time 51 ruler 3 -2/left/os_icon 17 1/gap 15 2/gap 63 1/right/command_execution_time 25 2/left_frame 55 -2/right/rust_version 41 -2/left_frame 7 1/right/package 43 -2/right/command_execution_time 25 1/right/status 23 -2/right/nodeenv 37 -2/left/dir 19 1/left/os_icon 17)
  local -a _p9k__display_v=(empty_line hide ruler hide 1 show 1/left_frame show 1/right_frame show 1/left show 1/right show 1/gap show 1/left/os_icon show 1/left/dir show 1/left/vcs show 1/right/status show 1/right/command_execution_time show 1/right/background_jobs show 1/right/virtualenv show 1/right/pyenv show 1/right/nodenv show 1/right/nvm show 1/right/nodeenv show 1/right/node_version show 1/right/rust_version show 1/right/package show 1/right/context show 1/right/ranger show 1/right/vim_shell show 1/right/time show 2 show 2/left_frame show 2/right_frame show 2/left show 2/right show 2/gap show 2/left/prompt_char show)
  function p10k() {
    emulate -L zsh -o no_hist_expand -o extended_glob -o no_prompt_bang -o prompt_percent -o no_prompt_subst -o no_aliases -o no_bg_nice -o typeset_silent -o no_rematch_pcre
  (( $+__p9k_trapped )) || { local -i __p9k_trapped; trap : INT; trap "trap ${(q)__p9k_trapint:--} INT" EXIT }
  local -a match reply mbegin mend
